...
Usage:
    python src/api/server.py                    # Runs on 127.0.0.1:8000
    python src/api/server.py --host 0.0.0.0     # Expose on all network interfaces
    python src/api/server.py --port 8080        # Custom port
    python src/api/server.py --reload           # Auto-reload on code edits
"""
...
from src.core.config import CONFIG, validate_environment
